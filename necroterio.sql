...
CREATE TABLE `cadaver` (
  ...
  `DataCheg` int NOT NULL,
  `HorarioCheg` int NOT NULL,
  `Datareti` int DEFAULT NULL,
  `Horarioreti` int DEFAULT NULL,
  `DataObi` int DEFAULT NULL,
  `HorarioObi` int DEFAULT NULL,
...
-- Dump completed on 2023-05-13 19:28:10
